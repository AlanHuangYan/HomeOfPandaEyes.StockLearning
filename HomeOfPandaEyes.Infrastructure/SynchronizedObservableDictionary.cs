...
{
    /// <summary>
    /// Synchronized Observable Dictionary Class
    /// </summary>
    /// <typeparam name="TKey">The type of the key.</typeparam>
    /// <typeparam name="TValue">The type of the value.</typeparam>
    public class SynchronizedObservableDictionary<TKey, TValue> : ObservableDictionary<TKey, TValue>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SynchronizedObservableDictionary&lt;TKey, TValue&gt;"/> class.
        /// </summary>
        public SynchronizedObservableDictionary() : this(null)
        {
        }
        ...
        public SynchronizedObservableDictionary(Dispatcher dispatcher = null, int count = 0) : base(count)
        {
            if (dispatcher == null)
            {
