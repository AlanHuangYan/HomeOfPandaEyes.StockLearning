namespace HomeOfPandaEyes.StockLearning
{
    ...
    { 
        ...
        private static void RunMigrations(string databaseKey)
        {
            ...
            // remove these lines if you want HomeOfPandaEyes.StockLearning migrations to run on your DB.
            ...
            using (var sw = new StringWriter())
            {
                ...
                var runner = new RunnerContext(announcer)
                {
                    ...
                    Namespace = "HomeOfPandaEyes.StockLearning.Migrations." + databaseKey + "DB",
                    Timeout = 90
                };
